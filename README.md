# Nodepay.ai
Register to Nodepay.ai : [https://app.nodepay.ai/register](https://app.nodepay.ai/register?ref=g5VOdd2OrrFDqB4)
...
- Register here [https://app.nodepay.ai/](https://app.nodepay.ai/register?ref=g5VOdd2OrrFDqB4)
 

## Obtain Required Information
1. Open the link and log in to [https://app.nodepay.ai/](https://app.nodepay.ai/register?ref=g5VOdd2OrrFDqB4)
...
```bash
git clone https://github.com/rahatmals1/nodepay.git
cd nodepay
```
